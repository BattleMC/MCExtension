...
@implementation UIDevice (MCExtension)
...
+ (BOOL)isIPhoneXSeries {
    ...
    if([[self platformStringSimple] containsString:@"iPhone X"] ||
       [[self platformStringSimple] containsString:@"iPhone10,3"] ||
       [[self platformStringSimple] containsString:@"iPhone10,6"] ||
       [[self platformStringSimple] containsString:@"iPhone11"]){
        return YES;
    } else {
        return ([[self platformStringSimple] containsString:@"Simulator"] &&
                ([UIScreen mainScreen].bounds.size.height == 812.00 ||
                 ...
                 [UIScreen mainScreen].bounds.size.height == 896.00 // XS Max
                 ));
    }
}
